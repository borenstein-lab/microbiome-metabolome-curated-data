...
gtdb.for.dada <- "../references/gtdb/sbdi_16s_gtdb_database/gtdb-sbdi-sativa.r06rs202.assignTaxonomy.fna.gz"
...
for (dataset in datasets) {
  ...
  asvs <- read_delim(asv.file, skip = 1, delim = '\t')
  ...
  message(paste("Sanity:",nrow(genera)))
  
  # Save
  write_delim(genera, file.path("../data/original_data", dataset, "feature_table_gtdb.tsv"), delim = "\t")
}
